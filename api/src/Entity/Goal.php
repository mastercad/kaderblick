...
#[ORM\Index(name: 'idx_goals_scorer_id', columns: ['scorer_id'])]
#[ORM\Index(name: 'idx_goals_game_id', columns: ['game_id'])]
#[ORM\Index(name: 'idx_goals_assist_by_id', columns: ['assist_by_id'])]
class Goal
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
