...
/**
 * @template-extends ServiceEntityRepository<PlayerNationalityAssignment>
 *
 * @implements OptimizedRepositoryInterface<PlayerNationalityAssignment>
 */
class PlayerNationalityAssignmentRepository extends ServiceEntityRepository implements OptimizedRepositoryInterface
{
    ...
    /**
     * @return PlayerNationalityAssignment[]
     */
    ...
    /**
     * @param array<int> $playerNationalityAssignmentIds
     */
    public function deleteByIds(array $playerNationalityAssignmentIds): void
    {
        if (0 === count($playerNationalityAssignmentIds)) {
            return;
        }

        $this->createQueryBuilder('pna')
            ->delete()
            ->where('pna.id IN (:ids)')
            ->setParameter('ids', $playerNationalityAssignmentIds)
            ->getQuery()
            ->execute();
    }
}
