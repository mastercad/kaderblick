...
async function loadUsers() {
    try {
        ...
        // Selects leeren und neu befüllen
        const selects = ['messageRecipients', 'groupMembers'];
        selects.forEach(selectId => {
            ...
            // Bootstrap Select neu initialisieren
            $(select).selectpicker({
                liveSearch: true,
                title: selectId === 'messageRecipients' ? 'Empfänger auswählen...' : 'Mitglieder auswählen...',
                size: 10,
                selectedTextFormat: 'count > 2',
                countSelectedText: '{0} ' + (selectId === 'messageRecipients' ? 'Empfänger' : 'Mitglieder') + ' ausgewählt'
            });
